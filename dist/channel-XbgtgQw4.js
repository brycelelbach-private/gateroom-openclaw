...
import { n as isSingleUseReplyToMode } from "./reply-reference-CRrndO5g.js";
...
import { c as normalizeMessagePresentation, s as normalizeInteractiveReply } from "./payload-BJLg3B8K.js";
import { n as resolveOutboundSendDep } from "./send-deps-DGn5WUfI.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-C8BoXENU.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-C3FX6wX9.js";
import "./text-runtime-BwruZakL.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-jZLhhsbc.js";
import "./channel-core-DJ7FIyjY.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-CUMp1lxR.js";
import "./approval-delivery-runtime-DUPtkHXh.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-C_0Kzpi2.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CHiYW6Kt.js";
...
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-3nLuZslq.js";
import "./reply-reference-DknVLOgJ.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-RNIWydlw.js";
import { k as createChannelMessageAdapterFromOutbound } from "./channel-message-ibxoZVQ3.js";
import { i as createAttachedChannelResultAdapter } from "./channel-send-result-Cc38MaXR.js";
import "./param-readers-BfkOO2y6.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-Os_sCS3Q.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-Bi-6tIVF.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-Ce0J3mHp.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-CKxDV2ox.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-DVQGPqug.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-gKh7FedJ.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-DNoVOI5G.js";
import "./channel-api-G6L2YURz.js";
import { r as createSlackWebClient } from "./client-BoWJKyFx.js";
import { r as normalizeAllowListLower } from "./allow-list-CyUq7Kiu.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-CQeW85es.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-BXN2j81S.js";
import { t as getOptionalSlackRuntime } from "./runtime-CcBLPKan.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-Mal6bS7Z.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-UPGHmRGW.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BoisKlEv.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-DOV7I_CA.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-LNIz-P-_.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-BymPRluJ.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CLJAsL8s.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-LhuQUO8e.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DfhogknB.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-D-Nje16F.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-Bo3fM45F.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DbBG4YCG.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-DwKe_1xr.js");
