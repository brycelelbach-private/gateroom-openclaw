...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-BDykHsv9.js";
import { r as resolveCrestodianOperation } from "./dialogue-DH7tA_-t.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-Dk78l8bc.js")).runCrestodianTui;
	opts.onReady?.();
