...
import { r as isOpenAIProvider, s as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-B5Dau954.js";
...
import { a as resolveSessionTranscriptFile, i as readTailAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-COq_Axhp.js";
...
import { Z as buildUsageWithNoCost } from "./compaction-successor-transcript-D0xMWZM7.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BD2ANbJT.js";
import { t as FailoverError } from "./failover-error-BVKbGVoi.js";
...
import { i as buildAgentRuntimeAuthPlan } from "./build-CTLOSn6s.js";
import { r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BfQkiT4T.js";
import { t as persistSessionEntry } from "./attempt-execution.shared-C6t3N8Eg.js";
import { t as runCliAgent } from "./cli-runner-TblnNUph.js";
import { i as resolveFallbackRetryPrompt, n as claudeCliSessionTranscriptHasContent, t as buildClaudeCliFallbackContextPrelude } from "./attempt-execution.helpers-DdViyRof.js";
import { t as clearCliSessionInStore } from "./session-store-BfMghl9C.js";
...
function resolveSessionPinnedAgentHarnessId(params) {
	...
	if (params.sessionEntry.agentHarnessId) {
		if (isOpenAIProvider(params.provider)) {
			...
			const configuredAgentHarnessId = configuredPolicy.runtime === "auto" || isCliRuntimeAlias(configuredPolicy.runtime) ? void 0 : configuredPolicy.runtime;
			const storedRuntime = normalizeEmbeddedAgentRuntime(params.sessionEntry.agentHarnessId);
			if (configuredAgentHarnessId && configuredPolicy.runtimeSource !== "implicit") return configuredAgentHarnessId;
			if (storedRuntime === "pi" && configuredAgentHarnessId) return configuredAgentHarnessId;
		}
