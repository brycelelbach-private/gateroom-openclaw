...
import { P as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-D9WMzrM-.js";
import { c as initSubagentRegistry } from "./subagent-registry-BTNa3t79.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-TMABO-b6.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-Dvvg6xNX.js";
import { n as listGatewayMethods } from "./server-methods-list-DfaMVyWq.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-HuNfCK45.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-cDljepiP.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-Bl7dz7CK.js");
