...
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-Cs_zUMxj.js";
import { n as VERSION } from "./version-C0yxKKZ8.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-CyEfEYg-.js";
import { c as normalizeAgentId } from "./session-key-C01Y8-9J.js";
import { a as resolveAgentDir, t as listAgentEntries } from "./agent-scope-config-Bj1Ovf8G.js";
...
import { d as createDiagnosticTraceContextFromActiveScope, f as formatDiagnosticTraceparent, l as createChildDiagnosticTraceContext, p as freezeDiagnosticTraceContext, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-Bv86Nw-F.js";
import { t as createSubsystemLogger } from "./subsystem-4YsHcs_C.js";
import { X as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-BvGD_Bil.js";
import "./defaults-4m7JJmD2.js";
import "./config-_rpt9b2u.js";
import { u as normalizeMessageChannel } from "./message-channel-Bzghcb_l.js";
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-CVvwPkW_.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-CMC8oaOl.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DDM_0ozQ.js";
import { o as resolveAgentRuntimePolicy, t as isCliRuntimeAlias } from "./model-runtime-aliases-D42aQk_c.js";
import { n as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-CRBOzJGa.js";
import { n as isOpenAICodexProvider, o as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-B5Dau954.js";
import { C as listRegisteredAgentHarnesses } from "./loader-CNBOmExt.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-Ba1r7w-q.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-DoDt9n3I.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-D9WMzrM-.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-eSSyIqIm.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-D4AEVEjr.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-CeiAuZxW.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-zywRqxlL.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-BYwayEVR.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-CEBK4_Qq.js";
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-B_4WBYd3.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BqDEuVvO.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-JV6d0RPn.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-eMRFwZvy.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-D9N7W6q2.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-S_dUTvKW.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-WdE48c4D.js";
import { C as isEmbeddedMode, S as stripProviderPrefix, c as resolveToolLoopDetectionConfig, x as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-DjdecLBf.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BDILRjsJ.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-BlhFVjJ-.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-BRh-AQUG.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-aZ_fo4si.js";
import { t as getMachineDisplayName } from "./machine-name-gkQJscAl.js";
import { m as MAX_IMAGE_BYTES } from "./mime-BgNEXalX.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-Vt79WvMF.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-mhCktmci.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-BMCF93rj.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-Bm7KxKlj.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-wneDp2RF.js";
import { i as getPluginToolMeta } from "./tools-BRBKoq76.js";
import { n as redactConfigObject } from "./redact-snapshot-kPnE6_be.js";
import { n as resolveCommitHash } from "./git-commit-ChLD7R7r.js";
import { t as resolveOsSummary } from "./os-summary-CkhmzTqZ.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-BgYeJNZJ.js";
import { n as estimateBase64DecodedBytes } from "./base64-BJlMv5YE.js";
import { d as parseBooleanValue } from "./frontmatter-CL7geVdw.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-Bk4Oj5OF.js";
import "./tts-DjRAgUNu.js";
import { B as collectRuntimeChannelCapabilities, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, G as assessLastAssistantMessage, H as findClientToolNameConflicts, I as isCacheTtlEligibleProvider, J as isZeroUsageEmptyStopAssistantTurn, K as dropReasoningFromHistory, L as readLastCacheTtlTimestamp, O as buildEmbeddedExtensionFactories, Q as isReasoningTagProvider, R as guardSessionManager, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, V as createClientToolNameConflictError, W as toClientToolDefinitions, X as buildStreamErrorAssistantMessage, Y as releaseWsSession, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, c as PI_RESERVED_TOOL_NAMES, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, q as dropThinkingBlocks, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-D0xMWZM7.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-BD2ANbJT.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Bn82tdyb.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-B8csLEMx.js";
...
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-8wWqNX-3.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-BwJb7e8z.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BnerH98C.js";
import { _ as resolveChannelReactionGuidance, h as resolveChannelMessageToolHints, m as listChannelSupportedActions } from "./pi-tools.before-tool-call-CRg2QQX4.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BWt8QPer.js";
import { a as isTimeoutError } from "./failover-error-BVKbGVoi.js";
import { t as buildModelAliasLines } from "./model-alias-lines-CS7PDsFa.js";
import { t as sanitizeForConsole } from "./console-sanitize-C0tJzibQ.js";
import { u as resolveModelAuthMode } from "./model-auth-DPsw2kct.js";
import { n as resolveTranscriptPolicy, o as collectTextContentBlocks, r as shouldAllowProviderOwnedThinkingReplay, s as supportsModelTools } from "./tool-result-middleware-DnhL0njA.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-Bx6t6B1P.js";
import { t as log$4 } from "./logger-TBztR_Sc.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CuwpmvIw.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-DCHZHj5K.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-R5UEMBKm.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-DWxPI_ic.js";
import { t as registerProviderStreamForModel } from "./provider-stream-VlwMZL_Z.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BNEOWJ2u.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Cdxb5RSd.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-CF5Wwa5r.js";
import "./pi-bundle-mcp-tools-DSlSbYo6.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-Bmkm7ShO.js";
import { S as isMessagingToolSendAction, _ as isToolResultError, b as sanitizeToolResult, d as runAgentCleanupStep, f as extractMessagingToolSend, g as filterToolResultMediaUrls, h as extractToolResultText, l as logAgentRuntimeToolDiagnostics, m as extractToolResultMediaArtifact, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolErrorMessage, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultTimedOut, x as isMessagingTool, y as sanitizeToolArgs } from "./attempt.tool-run-context-B2HyYESC.js";
import { r as parseFenceSpans } from "./fences-BLf_QIfW.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-WX4_de_J.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-Dp9nSOiP.js";
import { p as parseReplyDirectives } from "./deliver-CYL-_Cj3.js";
...
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-cmw1XIG5.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-C5XQg-hc.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-cAu7VEVM.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-CtrtGEvf.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-BszBsBWD.js";
...
import { t as detectRuntimeShell } from "./shell-utils-DCBxU8kh.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CCrfVJRl.js";
...
import "./tool-loop-detection-D-sMcggS.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-CTsZocMa.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BiRD3uLY.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-JSe03wME.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-B5t2A5Nd.js";
import { t as parseGeminiAuth } from "./gemini-auth-uYDZbyNJ.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-Fm8TQWRh.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-DOCXx5Xr.js";
import { t as appendAgentBootstrapSystemPromptSupplement } from "./system-prompt-Ca-vh2a4.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-DgjXo2r2.js";
...
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-rTgDY-yw.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-cgqwXLZw.js";
import { t as detectAndLoadPromptImages } from "./images-Bf1Yo4PQ.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, n as buildRuntimeContextSystemContext, t as buildCurrentTurnPromptContextSuffix } from "./runtime-context-prompt-CVyyvN5E.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-DGLvNFc1.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-lxRgWryC.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-DKeZtoQe.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-CIT5inyA.js"));
...
function buildAttemptSystemPrompt(params) {
	const baseSystemPrompt = params.systemPromptOverrideText ? appendRuntimeExtraSystemPrompt({
		...
		try {
			...
			try {
				...
				try {
					...
					const systemPromptForHook = (runtimeContextForHook ? composeSystemPromptWithHookContext({
						baseSystemPrompt: systemPromptText,
						appendSystemContext: buildRuntimeContextSystemContext(runtimeContextForHook)
					}) : void 0) ?? systemPromptText;
					const persistBlockedBeforeAgentRun = async (block) => {
						...
						try {
							...
							log$4.warn(`before_agent_run block: failed to persist redacted user message: ${err?.message ?? String(err)}`);
							return false;
						}
					};
					if (hookRunner?.hasHooks("before_agent_run")) {
						...
						try {
							...
							log$4.warn("before_agent_run hook failed; blocking request");
						...
						if (beforeRunDecision?.outcome === "block") {
							...
							log$4.warn(`before_agent_run hook blocked by ${beforeRunPluginId}`);
							await persistBlockedBeforeAgentRun({
...
function selectAgentHarnessDecision(params) {
	const pinnedPolicy = resolvePinnedAgentHarnessPolicy({ agentHarnessId: params.agentHarnessId });
...
function resolveAgentHarnessPolicy(params) {
	...
	const runtimeSource = envRuntime ? "env" : agentRuntime ? "agent" : defaultsRuntime ? "defaults" : "implicit";
	const runtime = envRuntime ? resolveEmbeddedAgentRuntime(env) : normalizeEmbeddedAgentRuntime(agentRuntime ?? defaultsRuntime);
	if (openAIProviderUsesCodexRuntimeByDefault({
		provider: params.provider,
		config: params.config
	})) {
		if (runtime === "pi") {
			if (runtimeSource === "implicit") return {
				runtime: "codex",
				runtimeSource
			};
			return {
		...
		if (runtime === "auto" || isCliRuntimeAlias(runtime)) return {
			runtime: "codex",
			runtimeSource
		};
		return {
