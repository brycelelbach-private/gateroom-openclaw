...
import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode, t as collectErrorGraphCandidates } from "./errors-SdKPttvI.js";
...
import { i as markdownToIR, n as renderMarkdownWithMarkers } from "./tables-DPya_LrH.js";
import { i as renderMarkdownIRChunksWithinLimit } from "./text-runtime-BwruZakL.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-dZJVSq2m.js";
import "./runtime-env-BIP-teS0.js";
import { t as resolveCommandAuthorization } from "./command-auth-uZVB_Yeh.js";
import "./conversation-runtime-CkaqEN-p.js";
import { n as expandAllowFromWithAccessGroups, r as parseAccessGroupAllowFromEntry } from "./access-groups-DzkPE4jr.js";
import "./command-auth-native-kYsIkmin.js";
import "./channel-inbound-B9-a3A_b.js";
import { t as formatLocationText } from "./location-Bu8LBW49.js";
import { t as resolveTelegramPreviewStreamMode } from "./preview-streaming-BIZCvyAu.js";
...
//#endregion
export { parseTelegramReplyToMessageId as $, resolveTelegramReplyId as A, hasBotMention as B, isTelegramCommandsAllowFromConfigured as C, resolveTelegramForumFlag as D, resolveTelegramDirectPeerId as E, buildSenderLabel as F, expandTelegramAllowFromWithAccessGroups as G, normalizeForwardedContext as H, buildSenderName as I, normalizeAllowFrom as J, resolveTelegramDmAllow as K, expandTextLinks as L, resolveTelegramThreadSpec as M, shouldUseTelegramDmThreadSession as N, resolveTelegramForumThreadId as O, withResolvedTelegramForumFlag as P, normalizeTelegramReplyToMessageId as Q, extractTelegramLocation as R, extractTelegramForumFlag as S, resolveTelegramCommandAuthorization as T, resolveTelegramMediaPlaceholder as U, isBinaryContent as V, resolveTelegramPrimaryMedia as W, resolveSenderAllowMatch as X, normalizeDmAllowFromWithStore as Y, resolveTelegramEffectiveDmPolicy as Z, buildTelegramParentPeer as _, splitTelegramHtmlChunks as a, resolveTelegramTargetChatType as at, buildTypingThreadParams as b, isSafeToRetrySendError as c, isTelegramRateLimitError as d, parseTelegramThreadId as et, isTelegramServerError as f, buildTelegramGroupPeerId as g, buildTelegramGroupFrom as h, renderTelegramHtmlText as i, parseTelegramTarget as it, resolveTelegramStreamMode as j, resolveTelegramGroupAllowFromContext as k, isTelegramClientRejection as l, buildGroupLabel as m, markdownToTelegramHtml as n, normalizeTelegramChatId as nt, wrapFileReferencesInHtml as o, stripTelegramInternalPrefixes as ot, tagTelegramNetworkError as p, isSenderAllowed as q, markdownToTelegramHtmlChunks as r, normalizeTelegramLookupTarget as rt, isRecoverableTelegramNetworkError as s, markdownToTelegramChunks as t, isNumericTelegramChatId as tt, isTelegramPollingNetworkError as u, buildTelegramRoutingTarget as v, resetTelegramForumFlagCacheForTest as w, describeReplyTarget as x, buildTelegramThreadParams as y, getTelegramTextParts as z };
