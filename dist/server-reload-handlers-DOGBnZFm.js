...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./channel-catalog-registry-CPYXS47s.js";
import "./installed-plugin-index-records-PLqOhF51.js";
import { n as formatConfigIssueLines } from "./issue-format-CW8ofM72.js";
import { m as resolveConfigWriteFollowUp } from "./runtime-snapshot-DCHHcAQJ.js";
import { n as isRestartEnabled } from "./commands.flags-92dXnB8d.js";
import { a as deferGatewayRestartUntilIdle, d as resolveGatewayRestartDeferralTimeoutMs, o as emitGatewayRestart, p as setGatewaySigusr1RestartPolicy } from "./restart-COZjHBbB.js";
import { o as resetModelCatalogCache } from "./model-catalog-B3BIyvqA.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-fowyFjUc.js";
import { r as resetDirectoryCache } from "./target-resolver-C-7tHpxL.js";
...
import { _ as resolveHooksConfig } from "./hooks-UHM8AOKQ.js";
import { r as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BVLFAIFJ.js";
import { i as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BiN73Rm2.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CXY5IX98.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-B7sWx9NT.js";
import { t as buildGatewayCronService } from "./server-cron-BKColtO5.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CcgLxIAu.js";
import { a as startGatewayCronWithLogging, i as startGatewayChannelHealthMonitor } from "./server-runtime-services-DFKGsf4E.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-B6yytrMN.js"), import("./gmail-watcher-lifecycle-DRO9Dk4_.js")]);
