import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString$1, d as normalizeStringifiedOptionalString, f as readStringValue, o as normalizeNullableString, s as normalizeOptionalLowercaseString } from "./string-coerce-Bje8XVt9.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CRSCIPqz.js";
import { v as resolveStateDir } from "./paths-BplLTi2s.js";
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-SdKPttvI.js";
import { n as isAbortError } from "./unhandled-rejections-CWuJ6eV_.js";
import { p as FsSafeError } from "./path-B_sJyaoq.js";
import { o as root } from "./secure-temp-dir-D9QHcAGk.js";
import { t as createAsyncLock } from "./async-lock-CW_c5r8v.js";
import "./fs-safe-C91ZNyPb.js";
import { t as movePathToTrash } from "./trash-BlpLdsoH.js";
import { p as resolveUserPath } from "./utils-Cs_zUMxj.js";
import { c as isSecretRef } from "./types.secrets-BgzzIHyp.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey, s as parseRawSessionConversationRef } from "./session-key-utils-CyEfEYg-.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BQglYFe1.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-C01Y8-9J.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-u8z01LvQ.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-Bj1Ovf8G.js";
...
import { a as logWarn, t as logDebug } from "./logger-C190dODJ.js";
import "./auth-Dfdul-Q1.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-qpriuehX.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-BvGD_Bil.js";
import { n as formatConfigIssueLines } from "./issue-format-CW8ofM72.js";
import { t as applyMergePatch } from "./merge-patch-DBzl0ZAi.js";
import { r as DEFAULT_PROVIDER } from "./defaults-4m7JJmD2.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Bi_vfhaD.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-DCHHcAQJ.js";
import { r as replaceConfigFile } from "./mutate-xGe9CIw4.js";
import "./config-_rpt9b2u.js";
import { n as isRestartEnabled } from "./commands.flags-92dXnB8d.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-CsTeNNWy.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-C59UVoNw.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-BQpyXDZU.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bzghcb_l.js";
import { r as setSafeTimeout } from "./timer-delay-BpnaUMDE.js";
import { o as gatewayStartupUnavailableDetails } from "./client-CO0vIOsX.js";
import { $ as validateExecApprovalsNodeGetParams, $t as validateSkillsDetailParams, A as validateConfigSchemaParams, An as validateToolsInvokeParams, B as validateDevicePairApproveParams, Bn as validateWizardCancelParams, Bt as validateSessionsDeleteParams, Cn as validateTalkSessionSubmitToolResultParams, D as validateConfigPatchParams, E as validateConfigGetParams, En as validateTalkSpeakParams, Et as validatePushTestParams, F as validateCronRemoveParams, Fi as COMMAND_DESCRIPTION_MAX_LENGTH, Fn as validateWebLoginWaitParams, Ft as validateSessionsCompactionBranchParams, G as validateDeviceTokenRotateParams, Gt as validateSessionsPatchParams, H as validateDevicePairRejectParams, Hn as validateWizardStartParams, Ht as validateSessionsListParams, I as validateCronRunParams, In as validateWebPushSubscribeParams, It as validateSessionsCompactionGetParams, Jt as validateSessionsResetParams, K as validateEnvironmentsListParams, Kt as validateSessionsPluginPatchParams, L as validateCronRunsParams, Ln as validateWebPushTestParams, Lt as validateSessionsCompactionListParams, Mn as validateUpdateStatusParams, Mt as validateSessionsAbortParams, N as validateCronAddParams, Nn as validateWakeParams, Nt as validateSessionsCleanupParams, O as validateConfigSchemaLookupParams, On as validateToolsCatalogParams, P as validateCronListParams, Pn as validateWebLoginStartParams, Pt as validateSessionsCompactParams, Q as validateExecApprovalsGetParams, Qt as validateSkillsBinsParams, R as validateCronStatusParams, Rn as validateWebPushUnsubscribeParams, Rt as validateSessionsCompactionRestoreParams, T as validateConfigApplyParams, Tt as validatePollParams, U as validateDevicePairRemoveParams, Un as validateWizardStatusParams, Ut as validateSessionsMessagesSubscribeParams, V as validateDevicePairListParams, Vn as validateWizardNextParams, Vt as validateSessionsDescribeParams, W as validateDeviceTokenRevokeParams, Wt as validateSessionsMessagesUnsubscribeParams, Xt as validateSessionsSendParams, Yt as validateSessionsResolveParams, Zt as validateSessionsUsageParams, _ as validateChannelsStatusParams, _n as validateTalkSessionCloseParams, _t as validateNodePendingAckParams, a as validateAgentsCreateParams, at as validateNodeDescribeParams, bn as validateTalkSessionJoinParams, c as validateAgentsFilesListParams, cn as validateTalkClientToolCallParams, ct as validateNodeInvokeParams, d as validateAgentsUpdateParams, dt as validateNodePairApproveParams, en as validateSkillsInstallParams, et as validateExecApprovalsNodeSetParams, f as validateArtifactsDownloadParams, ft as validateNodePairListParams, g as validateChannelsStartParams, gi as errorShape, gn as validateTalkSessionCancelTurnParams, gt as validateNodePairVerifyParams, h as validateChannelsLogoutParams, hi as ErrorCodes, hn as validateTalkSessionCancelOutputParams, ht as validateNodePairRequestParams, i as validateAgentWaitParams, in as validateTalkCatalogParams, it as validateModelsListParams, j as validateConfigSetParams, jn as validateUpdateRunParams, jt as validateSendParams, k as validateConfigSchemaLookupResult, kn as validateToolsEffectiveParams, l as validateAgentsFilesSetParams, lt as validateNodeInvokeResultParams, m as validateArtifactsListParams, mn as validateTalkSessionAppendAudioParams, mt as validateNodePairRemoveParams, n as validateAgentIdentityParams, nn as validateSkillsStatusParams, nt as validateLogsTailParams, o as validateAgentsDeleteParams, on as validateTalkClientCreateParams, ot as validateNodeEventParams, p as validateArtifactsGetParams, pn as validateTalkModeParams, pt as validateNodePairRejectParams, q as validateEnvironmentsStatusParams, qt as validateSessionsPreviewParams, r as validateAgentParams, rn as validateSkillsUpdateParams, rt as validateMessageActionParams, s as validateAgentsFilesGetParams, t as formatValidationErrors, tn as validateSkillsSearchParams, tt as validateExecApprovalsSetParams, u as validateAgentsListParams, un as validateTalkConfigParams, ut as validateNodeListParams, v as validateChannelsStopParams, vn as validateTalkSessionCreateParams, vt as validateNodePendingDrainParams, w as validateCommandsListParams, wn as validateTalkSessionTurnParams, wt as validatePluginsUiDescriptorsParams, xt as validateNodeRenameParams, yt as validateNodePendingEnqueueParams, z as validateCronUpdateParams, zn as validateWebPushVapidPublicKeyParams, zt as validateSessionsCreateParams } from "./protocol-0JcDkELB.js";
import { n as annotateInterSessionPromptText, o as normalizeInputProvenance } from "./input-provenance-CMC8oaOl.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-D1d5wmH4.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-B-FLT_xh.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-CbEiv_yZ.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-COZjHBbB.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-BJkK9kee.js";
...
import { g as patchPluginSessionExtension } from "./loader-CNBOmExt.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-CAi9Wuk4.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DhDhoi2f.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-D9WMzrM-.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-D9sZdVu7.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-eSSyIqIm.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-ChU7tIhh.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-D9cEgZJ1.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-BmdY-Qui.js";
import { h as stringifyRouteThreadId } from "./channel-route-DfppJbyJ.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-DrpHDBSq.js";
import { t as loadSessionStore } from "./store-load-D1NDZfCL.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-CA3xQtyM.js";
import { n as mergeSessionEntry } from "./types-Cg3npjOY.js";
import { o as updateSessionStore } from "./store-ykbL7YTc.js";
import "./plugins-C-IBDTFz.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-3sxpPPQt.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-DxLw863b.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-qg_gvOtp.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-CfGLLtke.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-BGXuEoVl.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-Bh0uuswB.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BH17ZXhU.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-CDrysQID.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-DiEWRz2R.js";
import { l as getTotalQueueSize } from "./command-queue-CEwMqbuX.js";
import { t as resolveAgentTimeoutMs } from "./timeout-BqDEuVvO.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-CqCXCGVD.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-B624oJ88.js";
import { t as extractToolPayload } from "./tool-payload-AR41EGV0.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-DV0KlEbu.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-bDUBf9Jk.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-i8YGONjS.js";
import { a as normalizeCronJobCreate, s as normalizeCronJobPatch } from "./openclaw-tools-DjdecLBf.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Bm7KxKlj.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-BRBKoq76.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-kPnE6_be.js";
import { D as synthesizeSpeech, O as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-Bk4Oj5OF.js";
import "./tts-DjRAgUNu.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Bn82tdyb.js";
import { i as resolveSandboxConfigForAgent } from "./config-BSXUJKVa.js";
import { a as isTimeoutError } from "./failover-error-BVKbGVoi.js";
import "./auth-profiles-BcvzFe1M.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-DtG0STkn.js";
import { l as projectOutboundPayloadPlanForMirror, r as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-CYL-_Cj3.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-C9iaDVpr.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-fowyFjUc.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-Jqc-0LaQ.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun, r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-CxLBjZIX.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DxjaFQSJ.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-IaNCa9Kp.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-CcWjwmXC.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-C-x5YHwH.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-ByPKzoin.js";
...
import "./target-resolver-C-7tHpxL.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CBEYKCSY.js";
import { i as resolveReplyToMode } from "./reply-threading-DLBbBS3p.js";
import { t as buildOutboundSessionContext } from "./session-context-BpGxszii.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-0MvO7C3B.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-DCNQt7rb.js";
import { r as resolveOutboundTarget } from "./targets-9uA9f43n.js";
import { n as resolveAgentIdentity } from "./identity-BJqKZTLs.js";
import { s as clearSessionQueues } from "./queue-DEDdU15D.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-DKKf3Axj.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DKwguO_q.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-1BEQj--v.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-CeaGnE6e.js";
...
import { o as loadWorkspaceSkillEntries } from "./workspace-CnhJS6fI.js";
import "./skills-DUHlfUX8.js";
import { n as resolveSendPolicy } from "./send-policy-CCcGjHu8.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CHSIVSCL.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-BsSQDLlr.js";
import "./commands-registry-E4r01smJ.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CbgF_9vz.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-DBWxQoCl.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-BtOBFP8z.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-CcHsGife.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-gJISydj-.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-BBfds2YE.js";
import { t as getChannelActivity } from "./channel-activity-BwoQNm-p.js";
import { t as WizardCancelledError } from "./prompts-BVRCDOHj.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-CB3sYMLj.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-GglXBEX4.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CbspqYjt.js";
import "./browser-maintenance-BerpoBbv.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-F3nQcNtI.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-DzHYi-c8.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-eJbBk18D.js";
import { r as agentCommandFromIngress } from "./agent-command-J2ZPc9YA.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-1JzlgJZh.js";
import { n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-ra23snL-.js";
import { t as safeParseJson } from "./server-json-DdGUTPw_.js";
import { t as formatForLog } from "./ws-log-CTyoKYiz.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-DiSwTf0q.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-BAJ3ufNw.js";
import { t as canExecRequestNode } from "./exec-defaults-58sYRIB-.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DZpLjiw7.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-WoX043Os.js";
...
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-B6IBK5Nn.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-BfbEaNK4.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-D_cqsdlR.js";
import { a as listRealtimeVoiceProviders, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, k as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage, x as recordTalkObservabilityEvent, y as createTalkSessionController } from "./session-runtime-5e0Akz11.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-CordmNM_.js";
import { n as createOutboundSendDeps } from "./deps-G7Jt9cF9.js";
import "./agent-BcdXkyns.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-B50QSolZ.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-CDYU3Sgo.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-BjVkD8DW.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DxhCAXI3.js";
import "./server-constants-BSG5uZ-2.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-Dd3Ml4u3.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-DsbO33xb.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BctsClhM.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-BTxrXxTk.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-BIzqTKe8.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-Cscy-BjY.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-AWtzEv0n.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-CNWLK-ke.js";
import { s as performGatewaySessionReset } from "./session-reset-service-BDy9rP5e.js";
import { t as buildChannelUiCatalog } from "./catalog-t2rTf43b.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-BzANgjEG.js";
import { s as normalizeUpdateChannel } from "./update-channels-B6cvtSlR.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-p9Cx762v.js";
import { t as readConfiguredLogTail } from "./log-tail-D7HXZsOj.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DtwyLOkm.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-DWTb5VQN.js";
import { t as buildChannelAccountSnapshot } from "./status-Kbex1ipa.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-BQPMbVLK.js";
import { t as installSkill } from "./skills-install-BeJA2FYL.js";
import { r as readPackageVersion } from "./package-json-CAFAr7AM.js";
import { t as getStatusSummary } from "./status.summary-BTWahKYD.js";
import "./status-DrXVHPGD.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-DP4loUrO.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-B9RW1CjL.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-CcivdjAV.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-D_uedX_J.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-B_QuhJPF.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CValGE4G.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BiN73Rm2.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-nkEhUS8r.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CXY5IX98.js";
import "./heartbeat-runner-lz5EGaXa.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-CEF4GFQD.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-CldNwUz_.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CCltRW3T.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BkVoTF5S.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-9A2wro4K.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-BlwEZAQ1.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-DdL6WFwT.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-BBT_ZU7G.js";
...
async function statWorkspaceFileSafely(workspaceRoot, name) {
	try {
...
function canBridgeNoDeviceApprovalFromBackend(params) {
	...
	return params.snapshot.requestedByDeviceId == null && params.snapshot.requestedByDeviceTokenAuth !== true && requestedByClientId !== null && BACKEND_BRIDGEABLE_NO_DEVICE_REQUEST_CLIENT_IDS.has(requestedByClientId) && isTrustedBackendApprovalClient(params.client);
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BWgS-0-z.js");
...
const sessionsHandlers = {
	"sessions.list": async ({ params, respond, context }) => {
		...
		const result = await listSessionsFromStoreAsync({
			cfg,
			storePath,
			store: p.configuredAgentsOnly === true ? filterSessionStoreToConfiguredAgents(cfg, store) : store,
		...
		try {
			...
			if (resolution.provider.createBrowserSession && transport !== "gateway-relay") {
				const session = await resolution.provider.createBrowserSession({
					...
					model: normalizeOptionalString$1(typedParams.model) ?? realtimeConfig.model,
					voice: normalizeOptionalString$1(typedParams.voice) ?? realtimeConfig.voice
				});
	...
	"talk.session.create": async ({ params, respond, context, client }) => {
		...
		try {
			...
			if (mode === "realtime") {
				...
				const model = normalizeOptionalString$1(params.model) ?? realtimeConfig.model;
				const voice = normalizeOptionalString$1(params.voice) ?? realtimeConfig.voice;
