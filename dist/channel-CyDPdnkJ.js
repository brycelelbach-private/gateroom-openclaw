...
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput } from "./types.secrets-BgzzIHyp.js";
...
import { t as readBooleanParam } from "./boolean-param-BtqTob37.js";
...
import { r as describeWebhookAccountSnapshot } from "./account-helpers-DNgnV8Mx.js";
import { a as createSetupInputPresenceValidator, l as patchScopedAccountConfig, u as prepareScopedSetupConfig } from "./setup-helpers-CLAbCTy7.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-jZLhhsbc.js";
...
import { T as projectAccountWarningCollector, x as createOpenGroupPolicyRestrictSendersWarningCollector } from "./channel-policy-DRouLMRv.js";
import { a as createAllowFromSection, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, t as addWildcardAllowFrom } from "./setup-wizard-helpers-BVwefJul.js";
...
import { d as createDefaultChannelRuntimeState, h as collectIssuesForEnabledAccounts, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Q6qpKJsI.js";
...
import { A as parseBlueBubblesAllowTarget, B as normalizeBlueBubblesServerUrl, D as looksLikeBlueBubblesTargetId, E as looksLikeBlueBubblesExplicitTargetId, F as resolveBlueBubblesEffectiveAllowPrivateNetwork, I as resolveDefaultBlueBubblesAccountId, N as listBlueBubblesAccountIds, O as normalizeBlueBubblesHandle, P as resolveBlueBubblesAccount, S as extractHandleFromChatGuid, a as isMacOS26OrHigher, j as parseBlueBubblesTarget, k as normalizeBlueBubblesMessagingTarget, n as getCachedBlueBubblesPrivateApiStatus, u as asRecord, w as inferBlueBubblesTargetChatType, x as buildBlueBubblesChatContextFromTarget, y as resolveGroupFlagFromChatGuid } from "./probe-DytTINOr.js";
import "./secret-input-Kn4ZxWRH.js";
import { t as BlueBubblesChannelConfigSchema } from "./config-schema-CpDGCGmB.js";
import { n as createBlueBubblesConversationBindingManager } from "./conversation-bindings-YBO1U6jk.js";
import { n as normalizeBlueBubblesAcpConversationId, r as resolveBlueBubblesConversationIdFromTarget, t as matchBlueBubblesAcpConversation } from "./conversation-id-Bx-OTS_O.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-9pI1lVeH.js";
import { n as resolveBlueBubblesGroupToolPolicy, t as resolveBlueBubblesGroupRequireMention } from "./group-policy-C403VRdD.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-hfXWV5Kv.js";
import { t as DEFAULT_WEBHOOK_PATH } from "./webhook-shared-C0LV9LSo.js";
...
const loadBlueBubblesActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-IWnOWF3f.js"), "blueBubblesActionsRuntime");
...
const loadBlueBubblesChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-D-yiHPTY.js"), "blueBubblesChannelRuntime");
function resolveBlueBubblesMessageLifecycleDeps(ctx) {
...
function resolveBlueBubblesReplyToMessageGuid(params) {
	...
	return params.runtime.resolveBlueBubblesMessageId(rawReplyToId, {
		requireKnownShortId: true,
...
async function sendBlueBubblesMediaWithRuntime(params) {
	...
	return await runtime.sendBlueBubblesMedia({
		...
		caption: params.extras?.caption ?? params.text ?? void 0,
		replyToId: resolveBlueBubblesReplyToMessageGuid({
			runtime,
			to: params.to,
			replyToId: params.replyToId
		}) ?? null,
...
function toBlueBubblesMessageSendResult(result, kind, replyToId) {
...
const bluebubblesMessageAdapter = defineChannelMessageAdapter({
	...
	send: {
		lifecycle: {
			beforeSendAttempt: async (ctx) => await resolveBlueBubblesMessageLifecycleDeps(ctx)?.beforeSendAttempt?.(ctx),
		...
		text: async (ctx) => toBlueBubblesMessageSendResult(await sendBlueBubblesTextWithRuntime({
			cfg: ctx.cfg,
			to: ctx.to,
			text: ctx.text,
		...
		media: async (ctx) => toBlueBubblesMessageSendResult(await sendBlueBubblesMediaWithRuntime({
			cfg: ctx.cfg,
			to: ctx.to,
			text: ctx.text,
...
const bluebubblesPlugin = createChatChannelPlugin({
	...
	outbound: {
		...
		attachedResults: {
			channel: "bluebubbles",
			sendText: async ({ cfg, to, text, accountId, replyToId }) => await sendBlueBubblesTextWithRuntime({
				cfg,
				to,
				text,
				accountId: accountId ?? void 0,
			...
			sendMedia: async (ctx) => {
				...
				if (!mediaUrl) throw new Error("BlueBubbles media send requires mediaUrl");
