...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-BhUQeU6M.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-B-FLT_xh.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-BhCkIslH.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-C57uqpQM.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-DMgEYWUS.js";
import { r as loadModelCatalog } from "./model-catalog-B3BIyvqA.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-BgNEXalX.js";
import { O as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-Bk4Oj5OF.js";
import "./tts-DjRAgUNu.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-4w9BpGv_.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DOmAUQlT.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-Bv6qTyNT.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-C17KP1c6.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CHSIVSCL.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DpGotxbQ.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-Cm7fwL3I.js";
...
import { t as collectOption } from "./helpers-CXvgbiyn.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-D7vR6B-i.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-BzANgjEG.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CIWCMxFI.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-TcO-f9Fp.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-Mg9fIHG1.js");
