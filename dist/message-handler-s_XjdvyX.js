...
import { s as resolveRuntimeServiceVersion } from "./version-C0yxKKZ8.js";
import { u as createDiagnosticTraceContext, y as runWithDiagnosticTraceContext } from "./diagnostic-events-Bv86Nw-F.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-D8Y23pOF.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-v5m7aBAk.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-Dfdul-Q1.js";
import { i as getRuntimeConfig } from "./io-BvGD_Bil.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-CsTeNNWy.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-C59UVoNw.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-Bzghcb_l.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-CO0vIOsX.js";
import { t as rawDataToString } from "./ws-B_J1uHL2.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-MH54X-X9.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-Bb6hRR6u.js";
import { Dt as validateRequestFrame, M as validateConnectParams, gi as errorShape, hi as ErrorCodes, t as formatValidationErrors } from "./protocol-0JcDkELB.js";
import "./version-DDZX6-Jd.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-B-FLT_xh.js";
import "./method-scopes-CbEiv_yZ.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-1JzlgJZh.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist } from "./node-command-policy-ra23snL-.js";
import { n as logWs, t as formatForLog } from "./ws-log-CTyoKYiz.js";
import { l as roleScopesAllow } from "./pairing-token-DmkbRdbM.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-WoX043Os.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-ChBj6tIy.js";
import { i as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-CSmOc94_.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-BfbEaNK4.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-a3oQG5fE.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DiS9nUHq.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-BSG5uZ-2.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-CldNwUz_.js";
import { r as upsertPresence } from "./system-presence-CCltRW3T.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-_abCX2UV.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BkVoTF5S.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CQ9kNJ4V.js";
import { t as truncateCloseReason } from "./close-reason-Co1Bz3Bx.js";
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			if (!client) {
				...
				if (maxProtocol < 4 || minProtocol > 4) {
					...
					sendHandshakeErrorResponse(ErrorCodes.INVALID_REQUEST, "protocol mismatch", { details: { expectedProtocol: 4 } });
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-CtYnqG4k.js");
