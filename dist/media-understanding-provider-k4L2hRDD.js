import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-Dg8i28hh.js";
import { i as resolveCodexAppServerRuntimeOptions } from "./config-Dgxz9tek.js";
import { a as readCodexErrorNotification, c as readCodexTurnCompletedNotification, n as assertCodexThreadStartResponse, r as assertCodexTurnStartResponse } from "./protocol-validators-c2PTnriW.js";
import { r as readModelListResult } from "./models-BRuR9js1.js";
...
async function describeCodexImages(req, options) {
	...
	const client = options.clientFactory ? await options.clientFactory(appServer.start, req.profile) : await import("./shared-client-Cyx8IM9z.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
