...
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-DSMqNpKO.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-eibNo8TH.js");
