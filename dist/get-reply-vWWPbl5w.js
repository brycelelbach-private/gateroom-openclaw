...
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-CyEfEYg-.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-C01Y8-9J.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-u8z01LvQ.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-Bj1Ovf8G.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-I9fP2Ebj.js";
import { l as resolveAgentSkillsFilter, p as resolveSessionAgentId } from "./agent-scope-Bf757dCA.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-w8O5Vqt5.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-D3yDKGxF.js";
...
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-Bzghcb_l.js";
import { a as isInterSessionInputProvenance, n as annotateInterSessionPromptText } from "./input-provenance-CMC8oaOl.js";
import { i as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-B5Dau954.js";
import { w as resetRegisteredAgentHarnessSessions } from "./loader-CNBOmExt.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-BmdY-Qui.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-DrpHDBSq.js";
import { c as resolveMaintenanceConfigFromInput, d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-D1NDZfCL.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-BBT02ZiZ.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-CA3xQtyM.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-Cg3npjOY.js";
import { b as resolveGroupSessionKey, d as resolveSessionStoreEntry, g as deriveSessionMetaPatch, o as updateSessionStore } from "./store-ykbL7YTc.js";
import { t as normalizeChatType } from "./chat-type-19KVFG2z.js";
import "./plugins-C-IBDTFz.js";
import { s as resolveSessionLifecycleTimestamps } from "./sessions-3sxpPPQt.js";
...
import { h as resolveModelRefFromString } from "./model-selection-shared-BL9Kfr1K.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-BGXuEoVl.js";
import "./model-selection-CEBK4_Qq.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-CEwMqbuX.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CDaaU8zF.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BlhFVjJ-.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-DUyL2beS.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-Vt79WvMF.js";
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-wneDp2RF.js";
import { n as resolveAgentHarnessPolicy } from "./selection-CaKP0wWy.js";
import { Q as isReasoningTagProvider } from "./compaction-successor-transcript-D0xMWZM7.js";
import { l as ensureAgentWorkspace } from "./workspace-Bn82tdyb.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-Fm-Lpy7I.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BM6OhY6Q.js";
import { o as collectTextContentBlocks } from "./tool-result-middleware-DnhL0njA.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Cdxb5RSd.js";
import "./pi-bundle-mcp-tools-DSlSbYo6.js";
import "./delivery-context-BtSLaPOr.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-CxLBjZIX.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-sHYDXuCI.js";
import { i as generateSecureToken } from "./secure-random-BcmtE_AA.js";
import { n as resolveSilentReplySettings } from "./silent-reply-riL_eRH7.js";
import { t as buildOutboundSessionContext } from "./session-context-BpGxszii.js";
import { r as resolveQueueSettings, t as isSteeringQueueMode } from "./queue-DEDdU15D.js";
...
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DfivkjFF.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-CII2Qt3d.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-BB9TD6hS.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-mPWwlFlB.js";
import "./commands-registry-E4r01smJ.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-L-pyNnnm.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-B5RV0RtN.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-Bsw7bAZy.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-B6f3NS_B.js";
import { t as finalizeInboundContext } from "./inbound-context-lwvobuu0.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BIkbT0Ir.js";
import { t as hasControlCommand } from "./command-detection-4EqIZse5.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-Dx5eONEL.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-DWJ8ebtv.js";
import { t as resolveFastModeState } from "./fast-mode-KUkWuFTK.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CdQti8Vq.js";
...
import { t as isDirectiveOnly } from "./directive-handling.directive-only-D7xoPQ2z.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-M4na6ovz.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-JXyV4j-3.js";
...
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-BhulH2kh.js";
import { t as hasInboundMedia } from "./inbound-media-DtnB8o34.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DVikNaxo.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-DdTr6tQv.js";
import { r as getCliSessionBinding } from "./cli-session-BfQkiT4T.js";
import { n as resolveResetPreservedSelection, t as clearSessionResetRuntimeState } from "./session-reset-cleanup-CA1IMg8B.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-BerpoBbv.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target--oi9ZyIa.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-NdbQ4JCm.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-BFD3relX.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-D50_hkKu.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-D57ycBfL.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-CVistIhz.js"));
...
async function runPreparedReply(params) {
	...
	let { prefixedCommandBody, queuedBody, transcriptCommandBody } = await traceRunPhase("reply.build_prompt_bodies", () => rebuildPromptBodies());
	...
	const resolveAcceptedAuthProfileProviders = (entry) => agentHarnessPolicy ? listOpenAIAuthProfileProvidersForAgentRuntime({
		provider,
		harnessRuntime: agentHarnessPolicy.runtime,
		sessionAgentHarnessId: entry?.agentHarnessId,
		sessionAgentRuntimeOverride: entry?.agentRuntimeOverride
	}) : [provider];
	let authProfileId = useFastReplyRuntime ? preparedSessionState.sessionEntry?.authProfileOverride : await traceRunPhase("reply.resolve_auth_profile", () => resolveSessionAuthProfileOverride({
		cfg,
		provider,
		acceptedProviderIds: resolveAcceptedAuthProfileProviders(preparedSessionState.sessionEntry),
		agentDir,
	...
	if (isActive && activeRunQueueAction === "run-now") {
		const queueState = await resolvePreparedReplyQueueState({
			...
			refreshPreparedState: async () => {
				...
				preparedSessionState = resolvePreparedSessionState();
				({prefixedCommandBody, queuedBody, transcriptCommandBody} = await traceRunPhase("reply.build_prompt_bodies", () => rebuildPromptBodies()));
			},
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-Dc29CFeX.js");
...
function createTypingController(params) {
	const { onReplyStart, onCleanup, typingIntervalSeconds = 6, typingTtlMs = 0, silentToken = SILENT_REPLY_TOKEN, log } = params;
...
const hookRunnerGlobalLoader = createLazyImportLoader(() => import("./hook-runner-global-lxRgWryC.js"));
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-ChGPzS3Z.js"));
	...
	if (sessionEntry?.pendingFinalDelivery && sessionEntry.pendingFinalDeliveryText) {
		...
		if (opts?.isHeartbeat) {
			...
			if (sessionKey && storePath) {
				const { updateSessionStoreEntry } = await import("./sessions-DK6BgFLG.js");
