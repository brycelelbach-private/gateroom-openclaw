...
import { p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-Bf757dCA.js";
...
import { i as isDiagnosticsEnabled, l as createChildDiagnosticTraceContext, p as freezeDiagnosticTraceContext, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-Bv86Nw-F.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-Bzghcb_l.js";
import { a as resolveCliRuntimeExecutionProvider, t as isCliRuntimeAlias } from "./model-runtime-aliases-D42aQk_c.js";
import { s as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-B5Dau954.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-CDy81J0a.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-eSSyIqIm.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-BmdY-Qui.js";
import { t as loadSessionStore } from "./store-load-D1NDZfCL.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-Cg3npjOY.js";
import { b as resolveGroupSessionKey, o as updateSessionStore, s as updateSessionStoreEntry } from "./store-ykbL7YTc.js";
import "./sessions-3sxpPPQt.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-BL9Kfr1K.js";
import { g as resolveResponseUsageMode, h as normalizeVerboseLevel } from "./thinking-BGXuEoVl.js";
import { t as isCliProvider } from "./model-selection-cli-DLWfdm_i.js";
import "./model-selection-CEBK4_Qq.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-BH17ZXhU.js";
import { l as queueEmbeddedPiMessage } from "./runs-B_4WBYd3.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CEwMqbuX.js";
import { a as enqueueSystemEvent } from "./system-events-B624oJ88.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CGoJYaEI.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-D9N7W6q2.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-S_dUTvKW.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-BUDZe9va.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-NHUw76IP.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-WdE48c4D.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BlhFVjJ-.js";
import { u as stripHeartbeatToken } from "./heartbeat-DUyL2beS.js";
import { o as isAudioFileName } from "./mime-BgNEXalX.js";
import { d as isLikelyExecutionAckPrompt, n as resolveAgentHarnessPolicy } from "./selection-CaKP0wWy.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-D0xMWZM7.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-BD2ANbJT.js";
import "./pi-embedded-helpers-Bf1kL3h7.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-CoPyyzi3.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-8wWqNX-3.js";
import { u as resolveModelAuthMode } from "./model-auth-DPsw2kct.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-DCHZHj5K.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-Dp9nSOiP.js";
import { p as parseReplyDirectives } from "./deliver-CYL-_Cj3.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-C5XQg-hc.js";
import { i as estimateMessagesTokens } from "./compaction-cAu7VEVM.js";
import { a as generateSecureUuid } from "./secure-random-BcmtE_AA.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload } from "./silent-reply-riL_eRH7.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DLBbBS3p.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-DR4NYTjL.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply--GmikSZf.js";
import { a as enqueueFollowupRun, c as scheduleFollowupDrain, l as refreshQueuedFollowupSession, n as resolvePiSteeringModeForQueueMode } from "./queue-DEDdU15D.js";
import { a as resolveContextTokensForModel } from "./context-DI4Zai31.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-C63ql5C9.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-1BEQj--v.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-CeaGnE6e.js";
import "./sandbox-CEbSXtHN.js";
import { n as resolveSendPolicy } from "./send-policy-CCcGjHu8.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-Bsw7bAZy.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DqwxF2LU.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-CcHsGife.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CTLOSn6s.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DPvHU_Kk.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CdQti8Vq.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-DVikNaxo.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BfQkiT4T.js";
import { t as runCliAgent } from "./cli-runner-TblnNUph.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-D31LsbAH.js";
import { t as formatProviderModelRef } from "./model-runtime-DItgkNqD.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C2CyBFji.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-oJT0QNnD.js";
	...
	while (true) try {
		...
		const fallbackResult = await runWithModelFallback({
			...
			run: async (provider, model, runOptions) => {
				...
				const requestedAgentHarnessId = agentRuntimeOverride && agentRuntimeOverride !== "auto" && agentRuntimeOverride !== "default" && !isCliRuntimeAlias(agentRuntimeOverride) ? agentRuntimeOverride : void 0;
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BkZ_6siE.js"));
