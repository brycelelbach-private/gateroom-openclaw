...
import { g as shortenHomePath, p as resolveUserPath } from "./utils-Cs_zUMxj.js";
...
import { i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride } from "./agent-scope-Bf757dCA.js";
import { r as writeRuntimeJson } from "./runtime-CDt9zNed.js";
import { r as normalizeProviderId } from "./provider-id-DAfV6Kh0.js";
import { G as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-BvGD_Bil.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-4m7JJmD2.js";
import "./config-_rpt9b2u.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-B_vP_2TR.js";
import { h as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-C57uqpQM.js";
import { o as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-B5Dau954.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-BYwayEVR.js";
import { _ as modelKey, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, y as parseModelRef } from "./model-selection-shared-BL9Kfr1K.js";
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-KZum-ADU.js";
...
import "./profiles-CXZVkqAd.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-NP3mbK0t.js";
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-DPsw2kct.js";
import { t as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-DA202yMs.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CNWLK-ke.js";
import { t as maskApiKey } from "./mask-api-key-DsLy0Lmu.js";
import { t as loadModelsConfig } from "./load-config-B8xhEp1y.js";
import { n as isRich } from "./list.format-DCgpUBYz.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-Dkz_gyFq.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-BRgDwAI1.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-BD-_Xdlr.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-DvFXGrFR.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const addProviderUse = (raw, allowCodexRuntimeFallback) => {
		...
		if (parsed?.provider) providerUses.push({
	...
	const hasUsableAuthForProviderInUse = (provider, options) => {
		if (providerAuthMap.has(provider) || syntheticAuthByProvider.has(provider)) return true;
		if (!options.allowCodexRuntimeFallback) return false;
		return openAIProviderUsesCodexRuntimeByDefault({
			provider,
			config: cfg
		}) && providerAuthMap.has("openai-codex");
	};
	const missingProvidersInUse = Array.from(new Set(providerUses.filter((usage) => !hasUsableAuthForProviderInUse(usage.provider, { allowCodexRuntimeFallback: usage.allowCodexRuntimeFallback })).map((usage) => usage.provider))).filter((provider) => !isCliProvider(provider, cfg)).toSorted((a, b) => a.localeCompare(b));
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-XIa0-Re6.js");
		runtime.log("");
