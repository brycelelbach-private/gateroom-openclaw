...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, l as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BOQQhVEM.js";
import "./ssrf-runtime-D54GqMPE.js";
import { t as getMSTeamsRuntime } from "./runtime-api-DzUOTQno.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-kRNEey_-.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-DtF12JmF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-5aPifmYw.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-gECpiwuV.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-xG94y6o2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwtModule, jwksModule]) => {
		return {
