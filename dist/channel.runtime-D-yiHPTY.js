...
import { a as createWebhookInFlightLimiter, c as readWebhookBodyOrReject } from "./webhook-request-guards-B2b8_Dfb.js";
import { t as normalizeWebhookPath } from "./webhook-path-LUDpjuwm.js";
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BzI5OOL9.js";
import "./string-coerce-runtime-C3oqjO8O.js";
import { F as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-DytTINOr.js";
import "./secret-input-Kn4ZxWRH.js";
import { t as getBlueBubblesRuntime } from "./runtime-CAyCqlLo.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-C0LV9LSo.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-C-9vZCVo.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-BPYjddGx.js";
	...
	return await withResolvedWebhookRequestPipeline({
		...
		handle: async ({ path, targets }) => {
			...
			const target = resolveWebhookTargetWithAuthOrRejectSync({
				...
				res,
				isMatch: (target) => {
					return safeEqualAuthToken(guid, normalizeSecretInputString(target.account.config.password) ?? "");
				}
			});
			if (!target) {
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-C9SMq8zJ.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
