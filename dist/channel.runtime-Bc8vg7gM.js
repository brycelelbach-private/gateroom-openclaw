...
import "./accounts-Vg3wA_5l.js";
import "./runtime-api-BvpzzxZo.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-mQoSykMg.js";
import { t as sendMessageZalo } from "./send-B3pCAh7O.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BZfK8qlW.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-gQbWdghX.js");
