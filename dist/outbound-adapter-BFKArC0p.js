...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-WdE48c4D.js";
import { n as resolveOutboundSendDep } from "./send-deps-DGn5WUfI.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-BnSjRpxM.js";
...
import { s as resolveDiscordAccount } from "./accounts-DvXtrnfK.js";
import { a as chunkDiscordTextWithMode, i as normalizeDiscordOutboundTarget } from "./normalize-Ct8Ql2DU.js";
import { p as DiscordError } from "./discord-DHpbORco.js";
import { t as createDiscordSendReceipt } from "./send.receipt-BTPVyVqT.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-C7uHeytm.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DIrWIQzo.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-yDYiwMd5.js");
