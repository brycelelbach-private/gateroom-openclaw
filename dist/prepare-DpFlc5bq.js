...
import { t as resolveConversationLabel } from "./conversation-label-B7Ra4rRQ.js";
...
import { n as resolveChannelSourceReplyDeliveryMode } from "./reply-pipeline-B2Zl44Td.js";
...
import { r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CrBLKCWH.js";
...
import { l as resolveSlackReplyToMode } from "./accounts-Os_sCS3Q.js";
import { r as parseSlackTarget } from "./target-parsing-Bi-6tIVF.js";
import { i as normalizeSlackAllowOwnerEntry, o as resolveSlackAllowListMatch, r as normalizeAllowListLower, s as resolveSlackUserAllowed } from "./allow-list-CyUq7Kiu.js";
import { i as hasSlackThreadParticipationWithPersistence, t as sendMessageSlack } from "./send-BG1_SAD9.js";
import { l as reactSlackMessage } from "./actions-BvLqu6-f.js";
import { c as resolveSlackThreadStarter, s as resolveSlackThreadHistory, u as formatSlackFileReference } from "./media-DROHJla4.js";
...
import "./send.runtime-B7UfIroO.js";
...
function loadSlackMediaModule$1() {
	slackMediaModulePromise$1 ??= import("./media-B1JZyUny.js");
...
function renderSlackUserMentions(text, renderedMentions) {
	...
	SLACK_USER_MENTION_RE.lastIndex = 0;
	return text.replace(SLACK_USER_MENTION_RE, (full, userId) => {
...
function loadSlackMediaModule() {
	slackMediaModulePromise ??= import("./media-B1JZyUny.js");
...
async function prepareSlackMessage(params) {
	...
	const explicitlyMentioned = Boolean(ctx.botUserId && (messageText.includes(`<@${ctx.botUserId}>`) || hasSubteamMention && await isSlackSubteamMentionForBot({
		client: ctx.app.client,
		text: messageText,
