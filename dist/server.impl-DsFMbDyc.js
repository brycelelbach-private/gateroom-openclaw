...
import { i as isNixMode } from "./paths-BplLTi2s.js";
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-BMNR7OIF.js";
import { _ as sleep } from "./utils-Cs_zUMxj.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-w8O5Vqt5.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-CaQ-xFuQ.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-D6wXvrDW.js";
import { c as setDiagnosticsEnabledForProcess, i as isDiagnosticsEnabled, u as createDiagnosticTraceContext, y as runWithDiagnosticTraceContext } from "./diagnostic-events-Bv86Nw-F.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-4YsHcs_C.js";
import { t as isContainerEnvironment } from "./container-environment-IJFnbn5j.js";
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-D8Y23pOF.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-v5m7aBAk.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-Dfdul-Q1.js";
import { n as resolveGatewayAuth } from "./auth-resolve-qpriuehX.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BvGD_Bil.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-DCHHcAQJ.js";
import { n as isRestartEnabled } from "./commands.flags-92dXnB8d.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-D_DCYOgD.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-B-FLT_xh.js";
import "./method-scopes-CbEiv_yZ.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-COZjHBbB.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CTA4EOML.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-D9WMzrM-.js";
import { i as resolveMainSessionKey } from "./main-session-ChU7tIhh.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-BBT02ZiZ.js";
import "./sessions-3sxpPPQt.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BH17ZXhU.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-D1ffJUEg.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-D0ykAgvP.js";
...
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-fowyFjUc.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-1JzlgJZh.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CTyoKYiz.js";
import { t as createDefaultDeps } from "./deps-G7Jt9cF9.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DiS9nUHq.js";
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-BDL5BTve.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-BSG5uZ-2.js";
import { t as GatewayLockError } from "./gateway-lock-DLiUEXqB.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-deq0MnsG.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-CdVeFb25.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CValGE4G.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-B7sWx9NT.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-DrhOxTRc.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-_abCX2UV.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-DW9eMres.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CcgLxIAu.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DfaMVyWq.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-D54bONvd.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-CQ9kNJ4V.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-BMfiDOr2.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-CTcINrgW.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-ASQe4Y8_.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Dd0gv3p0.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-Cluw6IFu.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BkBrJ6Vy.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B7oFptw-.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-BQaXL47K.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DFtavjf4.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-BU5xSO-T.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DXP38F19.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-BFSU7v6l.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-D9pwLaZF.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-B0PJiT6J.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-BQE7kJ_l.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-czd7ctSV.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DxEAoNLL.js");
	...
	httpServer.on("upgrade", (req, socket, head) => {
		runWithDiagnosticTraceContext(createDiagnosticTraceContext(), async () => {
			...
			if (handlePluginUpgrade) {
				...
				if ((shouldEnforcePluginGatewayAuth ?? shouldEnforceDefaultPluginGatewayAuth)(pathContext) && !(await getCachedPluginGatewayAuthBypassPaths(configSnapshot)).has(url.pathname)) {
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CILp43HK.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-DNpBan-U.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-DNpBan-U.js");
...
function resolveGatewayEventLoopHealthReasons(params) {
	...
	if (params.delayP99Ms >= EVENT_LOOP_DELAY_WARN_MS || params.delayMaxMs >= EVENT_LOOP_DELAY_WARN_MS) reasons.push("event_loop_delay");
	if (hasSustainedLoadWindow && params.utilization >= EVENT_LOOP_UTILIZATION_WARN) reasons.push("event_loop_utilization");
	if (hasSustainedLoadWindow && params.cpuCoreRatio >= CPU_CORE_RATIO_WARN) reasons.push("cpu");
	return reasons;
}
function createGatewayEventLoopHealthMonitor(deps = {}) {
	...
	return {
		snapshot: () => {
			...
			if (!(delayP99Ms >= EVENT_LOOP_DELAY_WARN_MS || delayMaxMs >= EVENT_LOOP_DELAY_WARN_MS) && intervalMs < SUSTAINED_LOAD_SAMPLE_MIN_INTERVAL_MS) {
				monitor.reset();
				return;
			}
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-DqmY44hf.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-DHyNer38.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-D8AkcqG4.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-D-apCYO2.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-SIEr633T.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-FiH78NrX.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DqmY44hf.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-C3yy4oNG.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-3hNzLUhj.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-CXWddZRl.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-DgaGd1O8.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-CCP7-_2l.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DBmQLygd.js");
	...
	const { createChannelManager } = await import("./server-channels-BQs_uXiZ.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-ClwwyMpH.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-CSVpA-F3.js"), import("./server-runtime-services-94GkIM6e.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-B7xTcTdk.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-Nv9DRKB8.js"),
				import("./server-plugin-bootstrap-Bl7dz7CK.js"),
				import("./services-bMfK6BDO.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-DshRyTOX.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-Bl7dz7CK.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-DfHLufdb.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-DTdCSzUy.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DOGBnZFm.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-lxRgWryC.js");
