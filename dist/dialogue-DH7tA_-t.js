import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-ebylDv7K.js";
import { r as loadCrestodianOverview } from "./overview-BDykHsv9.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-D7ZklXBT.js")).planCrestodianCommand)({
		input,
		overview
	});
