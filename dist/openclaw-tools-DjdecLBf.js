import { o as redactToolPayloadText } from "./redact-giw01WLO.js";
...
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-DVzO3f_c.js";
...
import { f as hasEncodedFileUrlSeparator, h as trySafeFileURLToPath } from "./fs-safe-C91ZNyPb.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-Cs_zUMxj.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-iP1XVmm1.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-CyEfEYg-.js";
import { n as normalizeAccountId } from "./account-id-BQglYFe1.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-C01Y8-9J.js";
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Bj1Ovf8G.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-Bf757dCA.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-CFaJUbTy.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-DgYFYTZA.js";
...
import { t as logDebug } from "./logger-C190dODJ.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BvGD_Bil.js";
import { h as isWindowsDrivePath } from "./archive-BJR-_kR4.js";
import { t as applyMergePatch } from "./merge-patch-DBzl0ZAi.js";
import { g as selectApplicableRuntimeConfig, i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DCHHcAQJ.js";
...
import { o as normalizeChannelId } from "./registry-BVumd_fQ.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-C59UVoNw.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-BQpyXDZU.js";
import { u as normalizeMessageChannel } from "./message-channel-Bzghcb_l.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-Bb6hRR6u.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-Bityq6oG.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-eSSyIqIm.js";
...
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-D1NDZfCL.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-CA3xQtyM.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BldeF5Ao.js";
...
import { a as extractDeliveryInfo } from "./sessions-3sxpPPQt.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-BYwayEVR.js";
import { _ as modelKey, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as normalizeModelRef } from "./model-selection-shared-BL9Kfr1K.js";
import { n as ensureOpenClawModelsJson } from "./models-config-a9IU6y8o.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-CEBK4_Qq.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-DiEWRz2R.js";
import { n as extractTextFromChatContent } from "./chat-content-eMRFwZvy.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-D9N7W6q2.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-7M3a0KEs.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-DV0KlEbu.js";
import { t as deriveSessionChatTypeFromKey } from "./session-chat-type-shared-CtVcBvNr.js";
...
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BgNEXalX.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bm7KxKlj.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-BRBKoq76.js";
import { O as textToSpeech } from "./tts-runtime-Bk4Oj5OF.js";
import "./tts-DjRAgUNu.js";
import { a as getImageMetadata } from "./image-ops-4w9BpGv_.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-BnerH98C.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-D_Ft6gLP.js";
import { f as listAllChannelSupportedActions, l as wrapToolWithBeforeToolCallHook, m as listChannelSupportedActions, s as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-CRg2QQX4.js";
import "./auth-profiles-BcvzFe1M.js";
import { n as listProfilesForProvider } from "./profile-list-C3fpPYkZ.js";
import { r as getApiKeyForModel } from "./model-auth-DPsw2kct.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-jLriTKA5.js";
import { t as SsrFBlockedError } from "./ssrf-C-oxBlw8.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Bmkm7ShO.js";
import { n as extractAssistantText } from "./pi-embedded-utils-D5gNCNHz.js";
import { n as runWithImageModelFallback } from "./model-fallback-C5XQg-hc.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError } from "./common-DPSDd5uL.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DTCHeh_G.js";
import { n as assertSandboxPath } from "./sandbox-paths-BlLdxEJN.js";
import "./local-file-access-CzC_WpO6.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-CLbgufpj.js";
...
import "./delivery-context-BtSLaPOr.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-Cq60k8LL.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-fowyFjUc.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-DEdMkPY-.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-Jqc-0LaQ.js";
import { o as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-CxLBjZIX.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DVWZ5umX.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Y1ws048O.js";
import { r as stripToolMessages } from "./chat-history-text-CahGp7lQ.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-B3VBYHhl.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DxjaFQSJ.js";
import { t as inferLegacyName } from "./normalize-iJV4bA2w.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-IaNCa9Kp.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Xm9o9sfl.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-C33aycmY.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BWMpIq79.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CYkKjyXq.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CJ3f-YDi.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DDN8xcSs.js";
import { u as saveMediaBuffer } from "./store-yO9n3Sa2.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-vSfT8t_X.js";
import { r as getDefaultLocalRoots } from "./local-media-access-DzvJD2qC.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-VOXcDkF3.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-DMAlCgeC.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-DlN5Ntdl.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-C-H2npHq.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-C1DwuUBG.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-v8RqHhA5.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-9g0PLAMf.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-DOmAUQlT.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-CF1RlbVE.js";
import { s as resolveTimeoutMs } from "./resolve-BRHnlxQQ.js";
import { t as buildProviderRegistry } from "./runner-DGd4IvaJ.js";
import "./media-understanding-DECV72Af.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CUXrVvaQ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-B57WyxUr.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CTDiFBke.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-C-x5YHwH.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-CUuRZJ0r.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-CAmzjbBE.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-15XRNydE.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CneN8I_t.js";
import { t as parseTimeoutMs } from "./parse-timeout-BcwF5GKI.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-BzXaWkM3.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DvDSTIts.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-CnKgeiUM.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-1BEQj--v.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-ZVmBp5mr.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DCRqqb11.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-Bj8lj0Cy.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-C8BVnInz.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-ClJmc7Fl.js";
import { _ as isReplySkip, f as runAgentStep, g as isNonDeliverableSessionsReply, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-session-cleanup-DrQDiMTd.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DdswmUny.js";
import { p as registerSubagentRun } from "./subagent-registry-BTNa3t79.js";
import { n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-DG1zxdn6.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-RoM8hFea.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-_ReNikAo.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DgMW8XAx.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-ArnEJXna.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-Bv6qTyNT.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-C_GAT9Wg.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CTInRE7z.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DzUzAqfd.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-iAqcqv7g.js";
import { i as runWebSearch } from "./runtime-C17KP1c6.js";
import "./web-search-provider-common-B3nliRhV.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BBazk3nv.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-BtXZdAbc.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-506MTmiE.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-M6-5OdvV.js"));
...
//#endregion
export { isEmbeddedMode as C, stripProviderPrefix as S, isParentOwnedBackgroundAcpSession as T, wrapToolWorkspaceRootGuardWithOptions as _, normalizeCronJobCreate as a, isStrictAgenticExecutionContractActive as b, resolveToolLoopDetectionConfig as c, createOpenClawReadTool as d, createSandboxedEditTool as f, wrapToolWorkspaceRootGuard as g, wrapToolMemoryFlushAppendOnlyWrite as h, listSupportedMusicGenerationModes as i, createHostWorkspaceEditTool as l, createSandboxedWriteTool as m, generateMusic as n, normalizeCronJobInput as o, createSandboxedReadTool as p, listRuntimeMusicGenerationProviders as r, normalizeCronJobPatch as s, createOpenClawTools as t, createHostWorkspaceWriteTool as u, sniffMimeFromBase64 as v, setEmbeddedMode as w, isStrictAgenticSupportedProviderModel as x, resolveOpenClawPluginToolsForOptions as y };
