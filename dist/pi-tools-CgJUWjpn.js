...
import { d as PATH_ALIAS_POLICIES, o as root } from "./secure-temp-dir-D9QHcAGk.js";
import "./fs-safe-C91ZNyPb.js";
import { r as openRootFile } from "./root-file-BmXzNSx2.js";
...
import { d as resolveGatewayMessageChannel } from "./message-channel-Bzghcb_l.js";
import { _ as wrapToolWorkspaceRootGuardWithOptions, c as resolveToolLoopDetectionConfig, d as createOpenClawReadTool, f as createSandboxedEditTool, g as wrapToolWorkspaceRootGuard, h as wrapToolMemoryFlushAppendOnlyWrite, l as createHostWorkspaceEditTool, m as createSandboxedWriteTool, p as createSandboxedReadTool, t as createOpenClawTools, u as createHostWorkspaceWriteTool, y as resolveOpenClawPluginToolsForOptions } from "./openclaw-tools-DjdecLBf.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName } from "./tool-policy-shared-Bm7KxKlj.js";
import { a as collectExplicitAllowlist, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy, u as mergeAlsoAllowPolicy } from "./tool-policy-wneDp2RF.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-BRBKoq76.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-BnerH98C.js";
import { l as wrapToolWithBeforeToolCallHook, p as listChannelAgentTools, u as copyChannelAgentToolMeta } from "./pi-tools.before-tool-call-CRg2QQX4.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-Ckn93FuG.js";
import { t as bindAbortRelay } from "./fetch-timeout-jLriTKA5.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Bmkm7ShO.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-DRc_HOdA.js";
import { n as assertSandboxPath } from "./sandbox-paths-BlLdxEJN.js";
import { a as toRelativeSandboxPath, i as resolvePathFromInput, r as resolveWorkspaceRoot } from "./read-capability-CLbgufpj.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-CdPuuIyO.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-J0GKb7qw.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-DEYn6Ouu.js";
import "./codex-native-web-search-zLuPBACZ.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-DEdMkPY-.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-DkXQ92qk.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-BdP68jlM.js"));
	...
	if (includeBaseCodingTools) for (const tool of createCodingTools(workspaceRoot)) {
		if (tool.name === "read") {
			if (sandboxRoot) {
				...
				base.push(workspaceOnly ? wrapToolWorkspaceRootGuardWithOptions(sandboxed, sandboxRoot, { containerWorkdir: sandbox.containerWorkdir }) : sandboxed);
				continue;
			}
