...
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey } from "./session-key-C01Y8-9J.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-Bj1Ovf8G.js";
import { r as replaceFileAtomicSync } from "./replace-file-Nprm-pSK.js";
import { t as createNonExitingRuntime } from "./runtime-CDt9zNed.js";
import { i as getChildLogger } from "./logger-DtcQ69OW.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-BkYSZEKh.js";
...
import { u as fireAndForgetHook } from "./hook-runner-global-DoDt9n3I.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-BmdY-Qui.js";
import { t as loadSessionStore } from "./store-load-D1NDZfCL.js";
import { d as resolveSessionStoreEntry, o as updateSessionStore } from "./store-ykbL7YTc.js";
import { t as resolveAndPersistSessionFile } from "./session-file-B3auZDBc.js";
import { S as findModelInCatalog, r as buildConfiguredModelCatalog } from "./model-selection-shared-BL9Kfr1K.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault } from "./model-selection-CEBK4_Qq.js";
import { a as modelSupportsVision, r as loadModelCatalog } from "./model-catalog-B3BIyvqA.js";
import { f as findCodeRegions, p as isInsideCode, u as stripReasoningTagsFromText } from "./assistant-visible-text-D9N7W6q2.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-CDaaU8zF.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-WdE48c4D.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-D5gNCNHz.js";
import { r as createOutboundPayloadPlan, s as projectOutboundPayloadPlanForDelivery } from "./deliver-CYL-_Cj3.js";
import { n as MediaFetchError } from "./fetch-fBPR6Vgy.js";
...
import { C as resolveChannelStreamingPreviewToolProgress, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, h as resolveChannelProgressDraftMaxLines, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, v as resolveChannelStreamingBlockEnabled } from "./channel-streaming-DsgZS8t-.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-2yGTHeC0.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-C8BoXENU.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-DKDXty1t.js";
import { t as resolveAckReaction } from "./identity-BJqKZTLs.js";
...
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DdswmUny.js";
...
import { n as listChatCommands } from "./commands-registry-list-BsSQDLlr.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-BB9TD6hS.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-E4r01smJ.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-B5RV0RtN.js";
import "./text-runtime-BwruZakL.js";
import "./routing-D3J5VUni.js";
import { a as getPluginCommandSpecs } from "./commands-BBfds2YE.js";
...
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-BwiLBGzr.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-BM56-zBM.js";
...
import { n as createPreviewMessageReceipt } from "./live-D9PBXdZh.js";
...
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Db0TgtK-.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-DSCmqM5V.js";
import "./runtime-env-BIP-teS0.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-V3B0Tw2Y.js";
import "./approval-reply-runtime-5sTyN-Ns.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-BENQghm4.js";
import "./reply-chunking-BxrOh5tW.js";
import { d as runInboundReplyTurn } from "./inbound-reply-dispatch-BrQrsJGw.js";
import "./outbound-runtime-BN7y4BFC.js";
import "./runtime-config-snapshot-VY0CS9sP.js";
import "./model-session-runtime-_vWH85a5.js";
import "./media-runtime-ElMrhsqI.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-CrBLKCWH.js";
import "./conversation-runtime-CkaqEN-p.js";
import "./agent-runtime-CkOer1yW.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-Cr5Z84M0.js";
import "./hook-runtime-DA4LNUm4.js";
import "./markdown-table-runtime-aoC9s2rs.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-CJWzuqic.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-B_qUAGW4.js";
import "./command-auth-native-kYsIkmin.js";
import "./command-primitives-runtime-UOvOtriC.js";
import "./command-status-DRpVtZri.js";
import "./command-detection-BmGlc7NR.js";
import "./command-surface-CjF4AK9n.js";
import { n as DEFAULT_EMOJIS, r as DEFAULT_TIMING } from "./channel-feedback-B06FHR36.js";
import { r as shouldDebounceTextInbound } from "./channel-inbound-B9-a3A_b.js";
import { n as toLocationContext, t as formatLocationText } from "./location-Bu8LBW49.js";
import { h as createMessageReceiveContext } from "./channel-message-ibxoZVQ3.js";
import "./session-store-runtime-CkCzVja9.js";
import "./models-provider-runtime-HmBhzntd.js";
import "./skill-commands-runtime-BuyFDl1b.js";
import "./native-command-config-runtime-BCbhNwjf.js";
import { t as mergeTelegramAccountConfig } from "./account-config-BCGpQmiz.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DrCKu3Cr.js";
import { A as resolveTelegramReplyId, B as hasBotMention, C as isTelegramCommandsAllowFromConfigured, D as resolveTelegramForumFlag, E as resolveTelegramDirectPeerId, F as buildSenderLabel, G as expandTelegramAllowFromWithAccessGroups, H as normalizeForwardedContext, I as buildSenderName, J as normalizeAllowFrom, K as resolveTelegramDmAllow, L as expandTextLinks, M as resolveTelegramThreadSpec, N as shouldUseTelegramDmThreadSession, O as resolveTelegramForumThreadId, P as withResolvedTelegramForumFlag, R as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramCommandAuthorization, W as resolveTelegramPrimaryMedia, X as resolveSenderAllowMatch, Y as normalizeDmAllowFromWithStore, Z as resolveTelegramEffectiveDmPolicy, _ as buildTelegramParentPeer, b as buildTypingThreadParams, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as resolveTelegramStreamMode, k as resolveTelegramGroupAllowFromContext, m as buildGroupLabel, p as tagTelegramNetworkError, q as isSenderAllowed, t as markdownToTelegramChunks, v as buildTelegramRoutingTarget, x as describeReplyTarget, y as buildTelegramThreadParams, z as getTelegramTextParts } from "./format-DsMYX0sc.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-DvX7v82q.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-CmXJilKy.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-MMTlgjwf.js";
import { n as resolveTelegramRequestTimeoutMs } from "./request-timeouts-CScmhrQE.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-DfuXm2Ad.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-DGB5b84X.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-ChG-aNaw.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-Bdoc8OB1.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-GzFyNJIq.js";
import { C as withTelegramApiErrorLogging, a as editMessageTelegram, g as recordSentMessage, x as buildInlineKeyboard } from "./send-Dg8_xUUq.js";
import { t as beginTelegramInboundTurnDeliveryCorrelation } from "./inbound-turn-delivery-BIG2MMGU.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-D0Up5UaM.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-e-S-YXt0.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-cCeXzbeP.js");
...
async function resolveTelegramCommandAuth(params) {
	...
	const commandAuthorized = commandsAllowFromConfigured ? Boolean(commandsAllowFromAccess?.isAuthorizedSender) : resolveCommandAuthorizedFromAuthorizers({
		...
		authorizers: [
			{
				configured: dmAllow.effectiveAllow.hasEntries,
			...
			bot.command(normalizedCommandName, async (ctx) => {
				...
				if (menu && commandDefinition) {
					const title = formatTelegramCommandArgMenuTitle({
						command: commandDefinition,
						menu,
						currentThinkingLevel: commandDefinition.key === "think" ? resolveTelegramThinkMenuCurrentLevel({
							cfg: runtimeCfg,
							agentId: route.agentId,
							...menuModelContext
						}) : void 0
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-DF1pKTRg.js")).defaultTelegramBotDeps;
						...
						runDispatch: () => telegramDeps.dispatchReplyWithBufferedBlockDispatcher({
							...
							dispatcherOptions: {
								...
								deliver: async (payload, info) => {
									...
									const telegramButtons = (payload.channelData?.telegram)?.buttons;
									...
									for (const segment of segments) {
										...
										const result = streamMode === "progress" && segment.lane === "answer" && info.kind === "final" ? await deliverProgressModeFinalAnswer(payload, segment.text) : await deliverLaneText({
									...
									if (split.suppressedReasoningOnly) {
										if (reply.hasMedia) await sendPayload(typeof payload.text === "string" ? {
											...payload,
											text: ""
										} : payload, { durable: info.kind === "final" });
