...
import { p as resolvePayloadMediaUrls, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-WdE48c4D.js";
import { l as presentationToInteractiveReply, u as renderMessagePresentationFallbackText } from "./payload-BJLg3B8K.js";
...
import { t as resolveTelegramToken } from "./token-rSR1ozmL.js";
...
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-RNIWydlw.js";
...
import { o as resolveTelegramAccount, r as listTelegramAccountIds } from "./accounts-DrCKu3Cr.js";
import { $ as parseTelegramReplyToMessageId, et as parseTelegramThreadId, g as buildTelegramGroupPeerId, it as parseTelegramTarget, nt as normalizeTelegramChatId, r as markdownToTelegramHtmlChunks, rt as normalizeTelegramLookupTarget } from "./format-DsMYX0sc.js";
import { a as telegramConfigAdapter, c as telegramSecurityAdapter, i as formatDuplicateTelegramTokenReason, n as createTelegramPluginBase, o as telegramSetupWizard, r as findTelegramTokenOwnerAccountId, s as telegramSetupAdapter, u as lookupTelegramChatId } from "./channel.setup-Jb2j75dW.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-CmXJilKy.js";
import { c as resolveTelegramExecApprovalTarget, f as shouldSuppressLocalTelegramExecApprovalPrompt, i as isTelegramExecApprovalClientEnabled, n as isTelegramExecApprovalApprover, o as isTelegramExecApprovalTargetRecipient, r as isTelegramExecApprovalAuthorizedSender, t as getTelegramExecApprovalApprovers, u as shouldHandleTelegramExecApprovalRequest } from "./exec-approvals-MMTlgjwf.js";
import { i as buildTelegramExecApprovalPendingPayload, o as telegramMessageActions$1, r as monitorTelegramProvider, t as probeTelegram } from "./probe-DJMCjDfk.js";
...
import { t as resolveTelegramInlineButtons } from "./button-types-Ca7L2vP1.js";
import { t as resolveTelegramInteractiveTextFallback } from "./interactive-fallback-CQbjfAf5.js";
import { t as resolveTelegramReactionLevel } from "./reaction-level-C3H_Xgo_.js";
import { r as resolveTelegramStartupProbeTimeoutMs } from "./request-timeouts-CScmhrQE.js";
import { t as getTelegramRuntime } from "./runtime-B-TZneKq.js";
import { t as parseTelegramTopicConversation } from "./topic-conversation-DcMllMf9.js";
import { t as resolveTelegramSessionConversation } from "./session-conversation-CP-03LOb.js";
import { t as detectTelegramLegacyStateMigrations } from "./state-migrations-CquARyKL.js";
import { a as setTelegramThreadBindingMaxAgeBySessionKey, i as setTelegramThreadBindingIdleTimeoutBySessionKey, t as createTelegramThreadBindingManager } from "./thread-bindings-ChG-aNaw.js";
...
const telegramNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-xbJgkOlu.js")).telegramApprovalNativeRuntime
	})
});
...
async function loadTelegramSendModule$1() {
	telegramSendModulePromise$1 ??= import("./send-cCeXzbeP.js");
...
function createTelegramOutboundAdapter(options = {}) {
	...
	return {
		...
		...createAttachedChannelResultAdapter({
			channel: "telegram",
			sendText: async ({ cfg, to, text, accountId, deps, replyToId, threadId, silent, gatewayClientScopes }) => {
			...
			sendMedia: async ({ cfg, to, text, mediaUrl, mediaLocalRoots, mediaReadFile, accountId, deps, replyToId, threadId, forceDocument, silent, gatewayClientScopes }) => {
				const { send, baseOpts } = await resolveTelegramSendContext({
					cfg,
					deps,
					accountId,
		...
		sendPayload: async ({ cfg, to, payload, mediaLocalRoots, mediaReadFile, accountId, deps, replyToId, threadId, forceDocument, silent, gatewayClientScopes }) => {
			const { send, baseOpts } = await resolveTelegramSendContext({
				cfg,
				deps,
				accountId,
...
async function loadTelegramSendModule() {
	telegramSendModulePromise ??= import("./send-cCeXzbeP.js");
